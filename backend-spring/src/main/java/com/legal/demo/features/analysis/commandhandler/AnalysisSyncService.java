...
import com.legal.demo.features.analysis.SummaryCommand;
...
@Service
@Transactional
public class AnalysisSyncService implements SummaryCommand {
    private static final Logger log = LoggerFactory.getLogger(AnalysisSyncService.class);
    ...
    public AnalysisSyncService(DocumentRepository documentRepo, AIModelClient aiClient) {
